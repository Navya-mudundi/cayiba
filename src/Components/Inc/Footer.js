            ...
            <div className="footer">
                            ...
                            <div class="map-marker-block aos-init aos-animate" data-aos="fade-right">
                                ...
                                <div class="map-marker-position position-1">
                                    <div class="map-marker  vert-move1">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/1.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                                <div class="map-marker-position position-2 scale-75">
                                    <div class="map-marker vert-move2">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/2.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                                <div class="map-marker-position position-3 scale-75">
                                    <div class="map-marker  vert-move2">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/3.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                                <div class="map-marker-position position-4 scale-50">
                                    <div class="map-marker  vert-move2">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/4.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                                <div class="map-marker-position position-5 scale-50">
                                    <div class="map-marker vert-move1">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/5.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                                <div class="map-marker-position position-6 scale-50">
                                    <div class="map-marker  vert-move2">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/6.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                                <div class="map-marker-position position-7 scale-50">
                                    <div class="map-marker vert-move1">
                                        <div class="map-pin bg-secondry"><img src="https://www.cayiba.com/resources/images/icons/10.png" alt=""/></div>
                                        <div class="pin-pulse"></div>
                                    </div>
                                </div>
                            </div>
              ...
              <div className='last-footer'>
                   ...
                   Cayiba.©2023 All rights reserved.
                    ...
                    <a href={upArrowLink} className="up-arrow">↑</a>
             </div>
        </>
    );
};
